...
class WGLinearizabilityTester[S <: Undoable](
	    ...
	    if(ret.compareResult(seqResult)){
	      ...
	      nextEv = logHeader.next
            ...
            case _ : java.lang.IllegalArgumentException =>
              ...
              // sequential object.  Note: we assume that the exception was
              // thrown without any change to the state of the sequential
              // object.
              nextEv = nextEv.next // advance to next op
          }
	}
